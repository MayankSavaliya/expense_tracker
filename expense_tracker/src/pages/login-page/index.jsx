...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-mint-50 to-lavender-50 flex flex-col justify-center items-center py-12 sm:px-6 lg:px-8">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                Not a member?{' '}
                <Link to="/register" className="font-medium text-mint-600 hover:text-mint-500 transition-colors">
                  Sign up
                </Link>
              </p>
            </div>
            <div className="mt-2 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/reset-password-request" className="font-medium text-mint-600 hover:text-mint-500 transition-colors">
                  Reset it
                </Link>
              </p>
            </div>
