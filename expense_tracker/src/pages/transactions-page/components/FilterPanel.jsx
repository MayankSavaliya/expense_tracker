    ...
    <div className="space-y-6">
      {isLoading ? (
        ...
        <>
          ...
          <div>
            <h4 className="text-sm font-medium text-gray-700 mb-3 flex items-center">
              <span className="w-8 h-8 rounded-lg bg-warning bg-opacity-20 flex items-center justify-center mr-2.5 shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-2.5">
              ...
              >
                <input
                  ...
                  className="text-gray-500 focus:ring-gray-500 focus:ring-2 focus:outline-none"
                />
                <span className={`text-sm ml-2.5 ${activeFilters.type === "all" ? "font-medium text-gray-700" : "text-gray-700"}`}>
                  All Types
                </span>
              </label>
              ...
              >
                <input
                  type="radio"
                  name="type"
                  checked={activeFilters.type === "expenses"}
                  onChange={() => onFilterChange("type", "expenses")}
                  className="text-lavender-500 focus:ring-lavender-500 focus:ring-2 focus:outline-none"
                />
                <span className={`text-sm ml-2.5 ${activeFilters.type === "expenses" ? "font-medium text-lavender-700" : "text-gray-700"}`}>
                  Expenses
                </span>
              </label>
              ...
              >
                <input
                  type="radio"
                  name="type"
                  checked={activeFilters.type === "payments"}
                  onChange={() => onFilterChange("type", "payments")}
                  className="text-mint-500 focus:ring-mint-500 focus:ring-2 focus:outline-none"
                />
                <span className={`text-sm ml-2.5 ${activeFilters.type === "payments" ? "font-medium text-mint-700" : "text-gray-700"}`}>
                  Payments
                </span>
              </label>
            </div>
